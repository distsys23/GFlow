...
class MultiAgentEnv:
    def __init__(self, dag):
        ...
        self.vm_events = np.zeros((5, self.vm_num))  # [task_num_of_vm, executing_task_time, wating_task_time, task_num_of_queue, vm_available_time]
    ...
    def reset(self):
        ...
        self.task_events = [False] * self.task_num
        self.vm_events = np.zeros((5, self.vm_num)) 
    ...
    def get_task_state(self):
        ...
        task_state = np.zeros((self.task_num, 4))
    ...
    def get_VM_state(self):
        vm_state = np.zeros((self.vm_num, 2))
        # vm available time 
        # print('self.vm_events[5,:]', self.vm_events[4,:])
        vm_state[:,0] = self.vm_events[4,:]
    ...
    def task_finish(self, vm_id):
        ...
        self.vm_events[4, vm_id] = self.dqn_events[5, task_id] # VM's available time
    ...
    def get_state(self):
        ...
        print('vm_tasknum',vm_tasknum)
        print('vm_executing',vm_executing)
        print('vm_waiting',vm_waiting)
